    ...
    if (_formKey.currentState.validate()) {
      ...
      try {
        ...
        Fluttertoast.showToast(
          msg: _res['responseMessage'],
          backgroundColor:AppColors.customDark,
          timeInSecForIosWeb: 2,
          toastLength: Toast.LENGTH_LONG,
        );
        if(_res['responseMessage'] == "Logged In"){
          // authenticationService.fetchUserProfile().then
          //   ((value) async {
          //   PrefManager prefManager = new PrefManager();
          //   await prefManager.setUserData(value
          //   ['responseBody']['user']);
